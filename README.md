...
### Features
* Lightweight & Minimal: Only the essentials—no extra
...
* ACAP-Ready: Built to run on Axis cameras as an acap, so your device keeps a sharp eye on itself.
...
Happy monitoring, and may no process escape your gaze!
